...
engineered_cols = ["log_n_sites", "log_volume_A3", "is_direct_gap", "density_g_cm3", 
             "is_magnetic", "magnetization_per_atom", "n_elements"]

magpie_cols = [col for col in data.columns if "MagpieData" in col]

features = data[engineered_cols + magpie_cols]
